...
# This function is called when the quick time hacking wasn't solved in the right amount of time and ends the game
    print("An alarm starts to ring")
    print()
    sleep(sl-3)
    print("Smoke starts entering the room, it smells funny")
    print()
    sleep(sl-2)
    print("You're eyes become heavier and heavier...")
    print()
    sleep(sl)
    print("GAME OVER")
    quit()
...
def choose_character():
    ...
    # from printing everything at once. As it is not very interesting to control hundreds of print statements we will mark every paragraph with a line of # in which only print and 
    # sleep functions are included.
    #################################################################################################################################################################################
...
def market_fight_scene(character, karma):
    ...
    # The quick time functions defined at the start of the code are called. Only when they are completed succesfully the fuction goes on and calls the continuig function.    
    else:
        #################################################################################################################################################################################
        sleep(sl-2)
        print()
...
def side_quest(character, karma):
    ...
    print()
    sleep(sl-2)
    print("You get on your way, you better want to do this quickly...")
    print()
    sleep(sl+1)
    print("After staking out the warehouse you conclude that the best way to this is quietly.")
    print()
    sleep(sl)
    print("The front is heavily protected by many guards. However there seems to be an unprotecteded side-door .")
    sleep(sl-2)
    print()
    print("There's a just a security console next to the door.")
    sleep(sl-2)
    ...
    print()
    sleep(sl-2)
    print("This Holocron you're looking for, it's in a secret base in the SACH3N sector. However, I don't know where exactly.")
    print()
    sleep(sl-2)
    sleep(sl)
    print("The SACH53N sector you think...")
...
def inside_base(character, karma):
    print("It seems as if the base is awfully protected, maybe they expect no one to find them here...")
    print()
    sleep(sl-2)
    ...
    print()
    sleep(sl-2)
    print("However it is protected by lasers, you have to be very careful to pass through them.")
    print()
    sleep(sl-2)
    ...
    print()
    sleep(sl)
    print("Hasty you leave everything behind you and start your ship.")
    print()
    sleep(sl)
    print("While your ship is leaving the planet, you feel a sign of relief.")
    print()
    sleep(sl)
    print("You fulfilled your mission.")
    print()
...
def end_sequence(character, karma):
    ...
    if character == "Jedi":
        ...
        if karma < 1:
            ...
            sleep(2*sl)
            print("Maybe you're deeds were truly not worthy of a Jedi.")
            sleep(2*sl)
